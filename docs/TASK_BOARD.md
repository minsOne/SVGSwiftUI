...
| P2-1 | P2 | Path command parser 구현 | in_progress | 독립 `SVGPathDataParser` 구현 + 단위테스트 완료, AST 연결 남음 |
...
| P8-1 | P8 | 테스트 확장/회귀 fixture | in_progress | 파서/캐시/path parser 테스트 33개 통과 |
